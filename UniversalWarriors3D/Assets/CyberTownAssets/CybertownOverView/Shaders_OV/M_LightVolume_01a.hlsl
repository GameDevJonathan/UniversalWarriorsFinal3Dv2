...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local8 = (Local3.rgb + Local6.rgb);
	MaterialFloat2 Local9 = (DERIV_BASE_VALUE(Local1) * MaterialFloat2(1.00000000,0.89999998));
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local9), 2);
	MaterialFloat4 Local11 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local9),View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 2);
	MaterialFloat3 Local13 = (Local8 * Local11.rgb);
	MaterialFloat Local14 = GetPixelDepth(Parameters);
	MaterialFloat Local15 = CalcSceneDepth(ScreenAlignedPosition(GetScreenPosition(Parameters)));
	MaterialFloat Local16 = (Local15 - DERIV_BASE_VALUE(Local14));
	MaterialFloat Local17 = (Local16 / 400.00000000);
	MaterialFloat Local18 = saturate(Local17);
	MaterialFloat3 Local19 = (Local13 * ((MaterialFloat3)Local18));
	MaterialFloat Local20 = dot(WorldNormalCopy,Parameters.CameraVector);
	MaterialFloat Local21 = max(0.00000000,Local20);
	MaterialFloat Local22 = (1.00000000 - Local21);
	MaterialFloat Local23 = abs(Local22);
	MaterialFloat Local24 = max(Local23,0.00010000);
	MaterialFloat Local25 = PositiveClampedPow(Local24,0.20000000);
	MaterialFloat Local26 = (Local25 * (1.00000000 - 0.89999998));
	MaterialFloat Local27 = (Local26 + 0.89999998);
	MaterialFloat Local28 = (1.00000000 - Local27);
	MaterialFloat3 Local29 = (Local19 * ((MaterialFloat3)Local28));
	MaterialFloat3 Local30 = (Local29 * ((MaterialFloat3)2.00000000));

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Local30;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(0.53630000,0.56447101,0.62000000).rgb;
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[1].x);
