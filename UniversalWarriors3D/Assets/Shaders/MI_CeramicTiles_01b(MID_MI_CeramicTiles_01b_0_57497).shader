Shader "Unreal/MI_CeramicTiles_01b(MID_MI_CeramicTiles_01b_0_57497)"
{
    Properties
    {
		...
		Material_Texture2D_2( "Main_TintMask", 2D ) = "white" {}
		Material_Texture2D_3( "Main_ORM(E)", 2D ) = "white" {}
		Material_Texture2D_4( "T_Bark_R", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_CeramicTiles_01b(MID_MI_CeramicTiles_01b_0_57497).hlsl"
