...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local0 = (View.GameTime * 0.00500000);
	MaterialFloat2 Local1 = Parameters.TexCoords[0].xy;
	MaterialFloat2 Local2 = (DERIV_BASE_VALUE(Local1) * MaterialFloat2(1.00000000,0.60000002));
	MaterialFloat2 Local3 = (MaterialFloat2(Local0,0.00000000) + DERIV_BASE_VALUE(Local2));
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local3), 0);
	MaterialFloat4 Local5 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local3),View.MaterialTextureMipBias));
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 0);
	MaterialFloat3 Local7 = (Local5.rgb * ((MaterialFloat3)0.00500000));
