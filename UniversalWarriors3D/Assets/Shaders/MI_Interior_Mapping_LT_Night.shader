Shader "Unreal/MI_Interior_Mapping_LT_Night"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Gloss_Roughness", 2D ) = "white" {}
		Material_TextureCube_0( "Param", Cube ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Interior_Mapping_LT_Night.hlsl"
