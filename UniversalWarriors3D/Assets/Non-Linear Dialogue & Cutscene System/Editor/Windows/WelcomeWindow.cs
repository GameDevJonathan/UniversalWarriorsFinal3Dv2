...
namespace FC_CutsceneSystem
{
    ...
    {  
        ...
        private void AddOnModules()
        {
            ...
            EditorGUILayout.LabelField(new GUIContent("Cinemachine", "This option enables Cinemachine support, but keep in mind that you must have installed the new Input System package before enabling this option"), GUILayout.Width(80));
