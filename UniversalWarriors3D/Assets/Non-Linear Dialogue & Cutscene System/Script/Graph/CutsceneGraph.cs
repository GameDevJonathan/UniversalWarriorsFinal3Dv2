...
namespace FC_CutsceneSystem
{
    public class CutsceneGraph : MonoBehaviour
    {
        ...
        public CutsceneEditorManager CutsceneEditorManager
        {
            get
            {
                return cutsceneEditorManager == null ? FindObjectOfType<CutsceneEditorManager>() == null ?
                  transform.parent.GetComponent<CutsceneEditorManager>() : FindObjectOfType<CutsceneEditorManager>() : cutsceneEditorManager;
            }
