...
//     version 1.11.2
//     from Assets/Non-Linear Dialogue & Cutscene System/Resources/InputAction/Input Action Manager.inputactions
//
...
public partial class @InputActionManager: IInputActionCollection2, IDisposable
{
    ...
    ~@InputActionManager()
    {
        UnityEngine.Debug.Assert(!m_Cutscene.enabled, "This will cause a leak and performance issues, InputActionManager.Cutscene.Disable() has not been called.");
    }
