Shader "Unreal/M_LightVolume_01a"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Clouds_01a", 2D ) = "white" {}
		Material_Texture2D_1( "T_TilingNoise03", 2D ) = "white" {}
		Material_Texture2D_2( "T_Clouds_03a", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_LightVolume_01a.hlsl"
