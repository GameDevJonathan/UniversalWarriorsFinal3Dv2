...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local1 = (DERIV_BASE_VALUE(Local0) * MaterialFloat2(1.00000000,1.39999998));
	...
	MaterialFloat Local5 = (Local3.r * Local3.r);
	MaterialFloat Local6 = (Local5 * 2.00000000);
	MaterialFloat3 Local7 = (((MaterialFloat3)Local6) * MaterialFloat3(8.00000000,5.50188589,4.19999981).rgb);
	MaterialFloat3 Local8 = lerp(Local7,Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);
	MaterialFloat Local9 = (1.00000000 - Local3.r);
	MaterialFloat Local10 = (Local9 * 0.30000001);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local12 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 1);
	MaterialFloat3 Local14 = (((MaterialFloat3)Local10) * Local12.rgb);
