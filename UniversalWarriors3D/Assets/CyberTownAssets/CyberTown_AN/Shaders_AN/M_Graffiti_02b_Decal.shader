Shader "Unreal/M_Graffiti_02b_Decal"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_Graffiti_02a_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_Bark_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_Graffiti_02a_Alpha", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Graffiti_02b_Decal.hlsl"
