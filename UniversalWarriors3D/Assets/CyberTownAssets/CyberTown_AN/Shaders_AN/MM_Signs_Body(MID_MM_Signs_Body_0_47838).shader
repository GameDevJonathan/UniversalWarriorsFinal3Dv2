Shader "Unreal/MM_Signs_Body(MID_MM_Signs_Body_0_47838)"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Swirl_FlowMapDiffTile_Warp", 2D ) = "white" {}
		Material_Texture2D_1( "Billboard_Texture", 2D ) = "white" {}
		Material_Texture2D_2( "WaveTexture", 2D ) = "white" {}
		Material_Texture2D_3( "T_Signs_01a_Mask_D", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MM_Signs_Body(MID_MM_Signs_Body_0_47838).hlsl"
