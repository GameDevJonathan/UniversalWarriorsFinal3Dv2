...
{
	Material.PreshaderBuffer[0] = float4(0.200000,0.029167,0.150769,30.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local2 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local3 = MaterialStoreTexSample(Parameters, Local2, 0);
	MaterialFloat Local4 = lerp(0.01000000,1.00000000,Local2.r);
	MaterialFloat3 Local5 = (Material.PreshaderBuffer[0].xyz * ((MaterialFloat3)Local4));
	MaterialFloat3 Local6 = (Local5 * ((MaterialFloat3)Material.PreshaderBuffer[0].w));
	MaterialFloat3 Local7 = lerp(Local6,Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat Local8 = lerp(0.10000000,0.25000000,Local2.r);
