Shader "Unreal/M_Poster_Decal"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Poster_Decal_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Poster_Decal_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_Concrete2_D", 2D ) = "white" {}
		Material_Texture2D_3( "T_Poster_Decal_Alpha", 2D ) = "white" {}
