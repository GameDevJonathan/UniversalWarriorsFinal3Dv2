Shader "Unreal/M_Neon_Obro(MID_M_Neon_Obro_0_53749)"
{
    Properties
    {
		...
		Material_Texture2D_0( "MainTexture", 2D ) = "white" {}
		Material_Texture2D_1( "Roughness", 2D ) = "white" {}
		Material_Texture2D_2( "Roughness2", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Neon_Obro(MID_M_Neon_Obro_0_53749).hlsl"
